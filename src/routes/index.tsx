...
import temploLogo from "@/assets/templo-logo.png.asset.json";
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-4 flex items-center justify-between">
        <a href="#topo" className="flex items-center group">
          <img
            src={temploLogo.url}
            alt="Templo Bar de Fé"
            className="h-12 sm:h-14 w-auto transition-transform duration-500 group-hover:scale-105"
          />
        </a>
